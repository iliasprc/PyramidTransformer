...
class ECAVideoTransformer(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        """
        super(ECAVideoTransformer, self).__init__()
        self.inplanes = 64
...
def eca_ir_csn_152_transformer(pretraining="ig65m_32frms", pretrained=False, progress=False, num_classes=226, **kwargs):
    avail_pretrainings = [
        "ig65m_32frms",
    ...
    if pretrained:
        if pretraining in avail_pretrainings:
            ...
            pretrained = False
    use_pool1 = True
    model = ECAVideoTransformer(block=Bottleneck, conv_makers=[IPConv3DDepthwise] * 4, layers=[3, 8, 36, 3],
