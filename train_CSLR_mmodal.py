...
from trainer_cslr.trainer_CSLR_mmodal import Trainer_CSLR_MModal
...
config_file = 'config/CSLR_MModal/trainer_config.yml'
...
def main():
    ...
    trainer = Trainer_CSLR_MModal(config=config, model=model, optimizer=optimizer,
